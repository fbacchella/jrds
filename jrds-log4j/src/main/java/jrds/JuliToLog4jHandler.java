...
public class JuliToLog4jHandler extends Handler {
    ...
    public static void catchLogger(java.util.logging.Logger jilogger) {
    ...
    public void publish(LogRecord record) {
        org.apache.log4j.Logger logger = Logger.getLogger(record.getLoggerName());
        org.apache.log4j.Level recordLevel = toLog4j(record.getLevel());
        if (recordLevel.isGreaterOrEqual(logger.getEffectiveLevel())) {
            logger.log(recordLevel, toLog4jMessage(record), record.getThrown());
        }
    }
