...
/**
 * This interface is used to indicate that a probe use a connexion Any class
 * using this interface should implement the following code :
 * <ul>
 ...
 * </ul>
 * 
 * This intereface is used by the Probe class to check if it needs to check the
 * connection started, so there is no need to overwrite the isStarted method.
 * 
 * @author Fabrice Bacchella
 * @version $Revision: 407 $, $Date: 2007-02-22 18:48:03 +0100 (jeu., 22 févr.
 *          2007) $
 */
