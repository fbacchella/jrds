...
extends RdsGraph {
	...
	static {
		...
		ds.setHostTree(new Object[] {
				GraphDesc.HOST, GraphDesc.NETWORK, GraphDesc.INTERFACES, GraphDesc.INDEX, "Packets exchanged"});
		ds.setViewTree(new Object[] {
				GraphDesc.NETWORK, GraphDesc.INTERFACES, GraphDesc.HOST, GraphDesc.INDEX, "Packets exchanged"});
