...
extends RdsSnmpSimple {
	...
	static {
		pd.add("la1", DsType.GAUGE, new OID(".1.3.6.1.4.1.2021.10.1.6.1"));
		pd.add("la5", DsType.GAUGE, new OID(".1.3.6.1.4.1.2021.10.1.6.2"));
		pd.add("la15", DsType.GAUGE, new OID(".1.3.6.1.4.1.2021.10.1.6.3"));
