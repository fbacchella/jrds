...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:output method="html" indent="yes"
		...
		omit-xml-declaration="yes" standalone="yes" encoding="UTF-8" />
	...
	<xsl:template match="name">
		<li>
			<a href="popup.html?pid={@pid}&amp;dsName={@dsName}"
				onclick="popup('pid={@pid}&amp;dsName={@dsName}',null); return false">
				<xsl:apply-templates />
			</a>
		</li>
	</xsl:template>
	...
	<xsl:template match="graphname">
		<li>
			<a href="popup.html?id={@id}" onclick="popup('id={@id}',null); return false">
				<xsl:apply-templates />
			</a>
		</li>
	</xsl:template>
