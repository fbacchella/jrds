...
/**
 * An enum to generate simple SNMP requesters which gets a probe, a collection
 * of ois and make snmp requests based on those oid
 * 
 * @author Fabrice Bacchella
 */
public enum SnmpRequester {
    /**
     * Collect a set of variable by append .0 to the OID of the oid the returned
     * OID are left unchanged
     */
    SIMPLE() {
        @Override
    ...
    /**
     * The simplest requester Just get a collection of oid and return the
     * associated value
     */
    RAW() {
        @Override
