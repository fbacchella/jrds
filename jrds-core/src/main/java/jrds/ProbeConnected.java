...
public abstract class ProbeConnected<KeyType, ValueType, ConnectionClass extends jrds.starter.Connection<?>> extends Probe<KeyType, ValueType> implements ConnectedProbe {
     ...
     * It also set the uptime for the probe, using connection data. One should
     * override setUptime if a probe use a specific uptime, that can't be
     * provided using the connection.
     * 
    ...
    /**
     * This method is used by getNewSampleValues to define the uptime for the
     * probe.<br>
     * The default way is to read it using the connection. It might be
